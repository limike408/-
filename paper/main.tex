...
$75922.1$~元，合计 $22536497.8$~元。表~\ref{tab:q3} 给出四个指定日期的对比。
\begin{table}[H]
    \centering
    ...
    \begin{tabular}{ccccc}
        ...
        \midrule[0.5pt]
        2025-03-20 & 37674.1 & 60428.8 & 0.0 & 0.0 \\
        2025-06-21 & 34650.3 & 66011.1 & 0.0 & 0.0 \\
        2025-09-23 & 43517.5 & 62940.2 & 0.0 & 0.0 \\
        2025-12-21 & 57196.6 & 84100.4 & 2446.2 & 427.8 \\
        \bottomrule[0.8pt]
    \end{tabular}
\end{table}
\begin{figure}[H]
...
以降低缺电量；而在因果口径下，滚动再计划虽能以最新预报对冲部分误差（表~\ref{tab:q3} 中三个
指定日期紧急购电降为 0），但由此触发的违约/超额惩罚使总费用在多数日期反而上升——预报更新的
边际价值在\textbf{仅当其对总量估计产生显著修正}时才为正。由此可明确：缺电风险的经济代价由预报
误差总量而非购电时机决定，这为引入更高精度的光伏预报（如 LSTM、数值天气预报）提供了量化依据。
...
将固定电价与波动电价、预报式两阶段随机与滚动 MPC 口径的全年费用汇总（表~\ref{tab:q4}）：
