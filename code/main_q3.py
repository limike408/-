...
def analysis(price, dates, load, pv, fc3, rec):
    ...
    ax.set_xticks(x); ax.set_xticklabels(df.day, fontsize=12)
    ax.set_ylabel('总购电费用(元)', fontsize=13); ax.set_title('问题3：是否引入多时刻预报', fontsize=14)
    ax.legend(fontsize=12); ax.grid(alpha=0.4, axis='y')
